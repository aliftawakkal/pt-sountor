                ...
                <div class="row">
                            ...
                            <div class="attendde">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="{{ route('checkout-remove', $detail->id) }}">
                                                    <img src="{{ url('frontend/images/avatar/Icon feather-delete.png') }}" alt="">
                                                </a>
                                            </td>
                                        </tr>
                                        @empty
                                ...
                                <div class="member mt-3">
                                    ...
                                    <form class="form-inline" method="POST" action="{{ route('checkout-create', $item->id) }}">
                                        ...
                                        <select name="is_visa" id="is_visa" required class="custom-select mb-2">
                                    ...
                                    <p class="disclaimer mb-0">
                                        Anda hanya dapat mengundang anggota yang telah terdaftar Sountor
                                    </p>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card card-details card-right">
                            ...
                            <h2>Informasi Periksa Perjalanan</h2>
                            ...
                            <p class="payment-instruction">
                                Silakan lengkapi pembayaran sebelum Anda
                                melanjutkan perjalanan yang luar biasa
                            </p>
                            <div class="bank">
                                <div class="bank-item pb-3">
                                    <img src="{{ url('frontend/images/avatar/bank1.png') }}" alt="" class="bank-image">
                                ...
                                <div class="bank-item pb-3">
                                    <img src="{{ url('frontend/images/avatar/bank2.png') }}" alt="" class="bank-image">
                                    <div class="description">
                                        <h3>PT Surya Pertama</h3>
                                        <p>
                                            Bank Kalse
                                            <br>
                                            0852 5252 7598
    ...
    <script>
        $(document).ready(function () {
            $('.datepicker').datepicker({
                ...
                icons: {
                    rightIcon: '<img src="{{ url('frontend/images/avatar/material-date-range.png') }}" />'
                }
            });
        });
    </script>
